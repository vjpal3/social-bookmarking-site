...
feature "User adds an article to bookmark", %Q{
  ...
  scenario "authorized user successfully adds article bookmark" do
    ...
    find_button("Add Bookmark").click
    expect(page).to have_content("Bookmark was successfully added.")
  ...
  scenario "authorized user fails to add article bookmark" do
    click_link "Add Article"
    find_button("Add Bookmark").click
    expect(page).to_not have_content("Bookmark was successfully added.")
    expect(page).to have_content("Url can't be blank")
    expect(page).to have_content("Title can't be blank")
  end

  scenario "unauthorized user attempts to add article bookmark" do
    click_link "Sign Out"
